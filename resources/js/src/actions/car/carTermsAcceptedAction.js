 ...
 */
export const carTermsAcceptedAction = async (dispatch, url, data, titleError) => {

  // dispara accion para saber que se realiza una peticion HTTP
  dispatch(loadingShow('Aceptando términos del carrito...'));
  ...
  try {
    ...
    const responseData = await HttpService(url, 'POST', data, headers);
